...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="56f4bb14-4fb9-45eb-8f6e-0e9637bf9e69" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('b377d148-c095-4402-8f21-71578acc112f')"
                dynamicCategory="2cc24a3e-fe24-4708-9a74-9c75406eebcd"
                userCaption="Inf Color Convert"
                enable="true"/>

      <!-- Define the web control which will be placed on our docker -->
      <itemData guid="bf0927ad-4023-421a-8664-3d8639cac99f"
                type="wpfhost"
                hostedType="Addons\InfColorConvert\InfColorConvert.dll,InfColorConvert.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="b377d148-c095-4402-8f21-71578acc112f"
                  userCaption="Inf Color Convert"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="bf0927ad-4023-421a-8664-3d8639cac99f"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
