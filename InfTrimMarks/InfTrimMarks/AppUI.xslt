...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="01b08b9a-6ddd-4620-b3db-5fb48c16f4f8" noBmpOnMenu="true"
                type="checkButton"
      ...
      <itemData guid="86947913-12d3-44a3-ade7-fe90049c69bd"
                type="wpfhost"
                hostedType="Addons\InfTrimMarks\InfTrimMarks.dll,InfTrimMarks.DockerUI"
                enable="true"/>
    ...
    <xsl:copy>
      ...
      <dockerData guid="5974a817-b075-4901-bd3d-57b1c6623de9"
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="86947913-12d3-44a3-ade7-fe90049c69bd"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
